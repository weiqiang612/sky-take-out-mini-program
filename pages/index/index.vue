        ...
        <view class="restaurant_info">
          ...
          <view class="info_top">
            ...
            <view class="info_top_right">
              <view class="right_title">
                <text>{{ merchantDisplayInfo().shopName || "苍穹外卖" }}</text>
              ...
              <view class="right_details">
                <view class="details_flex">
                  ...
                  <text class="icon_text">距离{{ merchantDisplayInfo().distance }}</text>
                </view>
                <view class="details_flex">
                  <image class="top_icon" src="../../static/money.png"></image>
                  <text class="icon_text">配送费{{ merchantDisplayInfo().deliveryFee }}元</text>
                </view>
                <view class="details_flex">
                  <image class="top_icon" src="../../static/time.png"></image>
                  <text class="icon_text">预计时长{{ merchantDisplayInfo().estimatedDeliveryTime }}</text>
                </view>
              </view>
            </view>
          </view>
          ...
          <view class="info_bottom">
            <view>
              ...
              <view class="address">
                <icon></icon>
                {{ merchantDisplayInfo().shopAddress || "商家店铺获取中.." }}
              </view>
            </view>
            <view>
